"""
Django settings for lionsfootball project.
...
SECRET_KEY = 'django-insecure-s86^csc11zbql+ol!te7i8&4zrgiv+dzty=pg5xbz6(jox*pp+'
...
ROOT_URLCONF = 'lionsfootball.urls'
...
WSGI_APPLICATION = 'lionsfootball.wsgi.application'
